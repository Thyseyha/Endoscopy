        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {tools.map((tool) => (
                    <Card
                        key={tool.name}
                        className="cursor-pointer hover:shadow-lg hover:border-primary-500 border-2 border-transparent transition-all duration-200"
...
const MainApp: React.FC = () => {
    ...
    const inactiveLinkClass = "text-primary-100 hover:bg-primary-600 hover:text-white";

    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900 font-sans">
            <div className="w-64 bg-primary-800 dark:bg-gray-800 text-white flex flex-col flex-shrink-0">
                <div className="px-4 py-4 flex items-center gap-3">
                    <span className="text-white bg-primary-600 p-2 rounded-lg">{ICONS.logo}</span>
